...
//			if (!dirs.contains(Direction.NORTH)) return "1x1_t_south";
//			if (!dirs.contains(Direction.SOUTH)) return "1x1_t_north";
//			if (!dirs.contains(Direction.WEST)) return "1x1_t_east";
//			return "t_west";
